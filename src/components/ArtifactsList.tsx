...
const ArtifactsList = ({ search, filterOptions }: ArtifactsListProps) => {
  ...
  if (filteredArtifacts?.length === 0) return <p>No results. Try again, please.</p>

  return (
    <div className='col-start-1 col-end-4 grid auto-rows-[minmax(100px,_2fr)] grid-cols-[repeat(auto-fill,_minmax(85px,_1fr))] gap-1 py-2'>
